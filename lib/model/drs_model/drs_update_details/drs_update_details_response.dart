...
String drsUpdateDetailsResponseToJson(DrsUpdateDetailsResponse data) => json.encode(data.toJson());
...
class DrsUpdateDetailsResponse {
  ...
  factory DrsUpdateDetailsResponse.fromJson(Map<String, dynamic> json) => DrsUpdateDetailsResponse(
...
class DrsDetailData {
  ...
  factory DrsDetailData.fromJson(Map<String, dynamic> json) => DrsDetailData(
        ...
        drsDetailList:
            List<DrsDetailList>.from(json["drsDetail"].map((x) => DrsDetailList.fromJson(x))),
      );
...
class DrsDetailList {
  ...
  factory DrsDetailList.fromJson(Map<String, dynamic> json) => DrsDetailList(
        ...
        podUploadFlag: json["podUploadFlag"] ?? '',
      );
