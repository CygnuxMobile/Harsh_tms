...
DrsSubmitRequest drsSubmitRequestFromJson(String str) =>
    DrsSubmitRequest.fromJson(json.decode(str));
...
class DrsSubmitRequest {
  ...
  factory DrsSubmitRequest.fromJson(Map<String, dynamic> json) => DrsSubmitRequest(
        ...
        updateDrsLits:
            List<UpdateDrsLit>.from(json["updateDRSLits"].map((x) => UpdateDrsLit.fromJson(x))),
