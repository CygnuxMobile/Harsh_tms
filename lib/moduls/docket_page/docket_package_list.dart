...
import '../../model/docket_model/docket.dart' show DocketInfo;
...
class DocketPackageScreen extends StatelessWidget {
          ...
          child: Column(
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(borderRadius: BorderRadius.circular(10), color: Colors.white, border: Border.all(width: 1, color: Colors.grey.withOpacity(0.5))),
                child: Padding(
              ...
              Flexible(
                child: ListView.builder(
                  itemCount: double.parse(argumentData.pkgsno.toString()).toInt(),
                  itemBuilder: (BuildContext context, int index) {
                    return Container(
                      decoration: BoxDecoration(borderRadius: BorderRadius.circular(10.0), color: Colors.white, border: Border.all(width: 1, color: Colors.grey.withOpacity(0.5))),
                                ...
                                Row(
                                  ...
                                  children: [
                                    Padding(
                                      ...
                                      child: const Image(
                                        image: AssetImage('assets/images/dashboardimages/qr-code 1.png'),
                                        height: 80,
                                      ),
                                    ),
                                    Align(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          TmsDocketListView(color: Color(0xff646D72), text: argumentData.dockdt, image: 'assets/images/dashboardimages/Calendar.png', height: 20),
                                          TmsDocketListView(
                                      ...
                                      child: InkWell(
                                        onTap: () async {
                                          if (!(await checkBluetoothStatus(context))) {
                                            ...
                                            ctrl.prnList.clear();
                                            ctrl.prnList.add(ctrl.getPrintData(argumentData, index));
                                            print(ctrl.prnList);
                                        ...
                                        child: Container(
                                          width: 80,
                                          height: 40,
                                          decoration: BoxDecoration(borderRadius: BorderRadius.circular(10), color: Color(0xff232F34)),
                                          child: const Center(
                                            child: TmsText(
                                              text: 'Print',
                                              color: Colors.white,
                                      ...
                                      Padding(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            if (argumentData.csgnnm.isNotEmpty) ...{
                                              Text(
                                                "${argumentData.csgnnm.length <= 10 ? argumentData.csgnnm : argumentData.csgnnm.substring(0, 10) + "..."}",
                                                style: TextStyle(color: Color(0xffC4CACD), fontWeight: FontWeight.bold, fontSize: 16),
                                              ),
                                            } else ...{
                                              Text(
                                                'Origin',
                                      ...
                                      Padding(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            if (argumentData.csgenm.isNotEmpty) ...{
                                              Text(
  ...
  TmsDocketListView({required String text, required String image, required double height, required Color color}) {
    return Row(
      children: [
        Image(
