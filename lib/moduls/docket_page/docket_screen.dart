                            ...
                            return Padding(
                              ...
                              child: InkWell(
                                onTap: () {
                                  ...
                                  Get.toNamed(AppRoutes.docketPackageScreen, arguments: [ctrl.docketData[index]]);
                                  // }
                                },
                                child: Obx(
                                  () => Container(
          ...
          children: [
            Row(
              ...
              children: [
                ...
                TmsDocketListView(text: '${ctrl.docketData[index].pkgsno}', image: 'assets/images/dashboardimages/Product.png', height: 30),
              ],
            ),
            TmsDocketListView(text: ctrl.docketData[index].dockdt, image: 'assets/images/dashboardimages/Calendar.png', height: 30),
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                TmsDocketListView(text: '${ctrl.docketData[index].actuwt}', image: 'assets/images/dashboardimages/Scale.png', height: 28),
                InkWell(
                  onTap: () async {
                    if (!await checkBluetoothStatus(context)) {
                      ...
                      for (int j = 0; j < pkg; j++) {
                        ctrl.prnList.add(ctrl.getPrintData(ctrl.docketData[index], j));
                      }
                      print(ctrl.prnList);
                  ...
                  child: Container(
                    ...
                    child: Center(
                      child: TmsText(
                        text: !(AppEnvironments.environments == Environments.harsh) ? "Print All" : 'Print',
                        color: Colors.white,
                      ),
                    ),
                  ),
            ...
            if (ctrl.docketData[index].csgnnm.isNotEmpty && ctrl.docketData[index].csgenm.isNotEmpty) ...{
              Padding(
