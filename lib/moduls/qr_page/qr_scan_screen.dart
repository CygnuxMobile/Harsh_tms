...
import 'package:harsh/moduls/qr_page/qr_scan_ontroller.dart';
        ...
        appBar: AppBar(
          actions: [
            if (dashBordMenuEnum == DashBordMenuEnum.manifest) ...{
              if (!(AppEnvironments.environments == Environments.harsh)) ...{
                Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: FlutterSwitch(
                    showOnOff: true,
                    value: Pref().getMfScan(),
                    activeIcon: Text("DOK"),
                    activeText: "",
                    inactiveIcon: Text("PKT"),
                    inactiveText: "",
