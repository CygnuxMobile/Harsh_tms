...
import 'package:harsh/moduls/pod_page/widget/image_bottom_sheet.dart';
import 'package:harsh/moduls/pod_page/widget/pod_upload_filter.dart';
...
class PodUploadScreen extends StatelessWidget {
    ...
    return Expanded(
      child: GestureDetector(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            color: isSelected ? Color(0xff232F34) : Colors.transparent,
            borderRadius: BorderRadius.circular(16),
          ),
          ...
          child: Text(
            label,
            style: TextStyle(
              color: isSelected ? Colors.white : Color(0xff232F34),
  ...
  Widget _buildPodList() {
    ...
    final filteredList = podUploadController.podList.where((item) => isOnlineTab ? item.apiStatusIndex != 1 : item.apiStatusIndex == 1).toList();
