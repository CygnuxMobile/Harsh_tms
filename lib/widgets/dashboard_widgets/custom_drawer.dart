...
import 'package:harsh/environments%20.dart';
import 'package:harsh/moduls/arrival_page/arrival_controller.dart';
import 'package:harsh/moduls/home_page/dash_board_controller.dart';
import 'package:harsh/moduls/login_page/login_controller.dart';
import 'package:harsh/moduls/stock_update_page/stock_update_controller.dart';
import 'package:harsh/moduls/unloading_page/unloading_screen_controller.dart';
...
StockUpdateController stockUpdateController = Get.put(StockUpdateController());
  ...
  return Drawer(
    child: ListView(
      ...
      children: [
            ...
            children: [
              Container(
                ...
                child: CircleAvatar(
                  child: ClipOval(
                    child: Image(
                      image: const AssetImage('assets/images/launcher-icon-tms.jpg'),
                      fit: BoxFit.cover,
                    ),
                    // child:
                  ),
        ...
        Center(child: Text(AppEnvironments.version)),
      ],
    ),
  );
}
...
/// StockUpdate bottomSheet
Future<void> stockUpdateBottomSheetArrival(BuildContext context) async {
  showModalBottomSheet(
    context: context,
    backgroundColor: Colors.transparent,
    builder: (BuildContext bc) {
                    ...
                    child: Column(
                      children: [
                        ...
                        Form(
                          key: _formKey1,
                          child: TextFormField(
                            controller: stockUpdateController.thcNumberController,
                            decoration: InputDecoration(
                              // hintText: 'Username',
                              labelText: 'THC Number',
                              labelStyle: TextStyle(color: Colors.black),
                        ...
                        Container(
                          child: TextFormField(
                            controller: stockUpdateController.stockUpdateFromDateCtl,
                            decoration: const InputDecoration(
                              // hintText: 'Username',
                              labelText: ' From Date',
                              labelStyle: TextStyle(color: Colors.black),
                            ...
                            onTap: () async {
                              ...
                              stockUpdateController.stockUpdateFromDateCtl.text = FromDate;
                            },
                          ),
                        ),
                        SizedBox(
                        ...
                        Container(
                          child: TextFormField(
                            controller: stockUpdateController.stockUpdateToDateCtl,
                            decoration: const InputDecoration(
                              // hintText: 'Username',
                              labelText: ' TO Date',
                              labelStyle: TextStyle(color: Colors.black),
                            ...
                            onTap: () async {
                              ...
                              date = await showDatePicker(
                                  ...
                                  lastDate: DateTime(2100));
                              String toDate = DateFormat('yyyy-MM-dd').format(date!);
                              stockUpdateController.stockUpdateToDateCtl.text = toDate;
                            },
                          ),
                        ),
                        SizedBox(
                        ...
                        TmsButton(
                          onPressed: () {
                            if (ctrl1.vehicleNumberController.text.isNotEmpty ||
                              ...
                              stockUpdateController.stockUpdateListApi(context);
                            } else {
                              TmsToast.msg('Please fill anyone');
                            }
                          },
                  ...
                  child: Column(
                    children: [
                      ...
                      TmsButton(
                        onPressed: () {
                          Get.back();
                          drsController.drsListDataStatus.value = DataStatus.loading;
